...
@Component({
  selector: 'app-crear-mantenimiento-admin',
  imports: [CommonModule, FormsModule, RouterLink, SidebarAdmin],
  templateUrl: './crear-mantenimiento-admin.html',
  styleUrl: './crear-mantenimiento-admin.scss',
})
export class CrearMantenimientoAdmin implements OnInit {
  // listas para selects
  maquinas: Maquinaria[] = [];
  usuarios: Usuario[] = [];
