...
@Component({
  selector: 'app-crear-registro-horas-maquinaria-operador',
  imports: [CommonModule, FormsModule, SidebarOperador],
  templateUrl: './crear-registro-horas-maquinaria-operador.html',
  styleUrl: './crear-registro-horas-maquinaria-operador.scss',
})
export class CrearRegistroHorasMaquinariaOperador {
  maquinas: Maquinaria[] = [];
  usuarios: Usuario[] = [];
  proyectos: Proyecto[] = [];
