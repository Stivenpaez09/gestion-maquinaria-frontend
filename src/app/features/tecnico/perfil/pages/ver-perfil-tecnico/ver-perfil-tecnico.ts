...
@Component({
  selector: 'app-ver-perfil-tecnico',
  imports: [DatePipe, SidebarTecnico],
  templateUrl: './ver-perfil-tecnico.html',
  styleUrl: './ver-perfil-tecnico.scss',
})
export class VerPerfilTecnico {
  // Datos principales
