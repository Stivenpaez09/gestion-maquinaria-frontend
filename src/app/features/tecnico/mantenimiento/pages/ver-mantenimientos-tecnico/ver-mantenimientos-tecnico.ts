...
@Component({
  selector: 'app-ver-mantenimientos-tecnico',
  imports: [RouterLink, CommonModule, FormsModule, SidebarTecnico],
  templateUrl: './ver-mantenimientos-tecnico.html',
  styleUrl: './ver-mantenimientos-tecnico.scss',
})
export class VerMantenimientosTecnico {
  ...
  verDetalle(m: Mantenimiento): void {
    this.router.navigate(['/detalles-mantenimiento-tecnico', m.id_mantenimiento]);
  }
}
