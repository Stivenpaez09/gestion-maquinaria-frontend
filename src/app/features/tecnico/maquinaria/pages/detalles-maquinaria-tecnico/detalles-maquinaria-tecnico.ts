...
@Component({
  selector: 'app-detalles-maquinaria-tecnico',
  imports: [CommonModule, RouterLink, FormsModule, SidebarTecnico],
  templateUrl: './detalles-maquinaria-tecnico.html',
  styleUrl: './detalles-maquinaria-tecnico.scss',
})
export class DetallesMaquinariaTecnico {
  // Datos principales
  ...
  abrirDetalleMantenimiento(id_programado: number): void {
    this.router.navigate(['/detalles-mantenimiento-programado-tecnico', id_programado]);
  }
