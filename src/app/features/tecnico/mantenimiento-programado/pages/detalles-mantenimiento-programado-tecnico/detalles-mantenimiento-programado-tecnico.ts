...
@Component({
  selector: 'app-detalles-mantenimiento-programado-tecnico',
  imports: [CommonModule, FormsModule, RouterModule, RouterLink, SidebarTecnico],
  templateUrl: './detalles-mantenimiento-programado-tecnico.html',
  styleUrl: './detalles-mantenimiento-programado-tecnico.scss',
})
export class DetallesMantenimientoProgramadoTecnico {
  cargando = false;
