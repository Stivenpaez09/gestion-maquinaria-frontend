...
@Component({
  selector: 'app-ver-mantenimientos-responsable',
  imports: [CommonModule, FormsModule, SidebarResponsable],
  templateUrl: './ver-mantenimientos-responsable.html',
  styleUrl: './ver-mantenimientos-responsable.scss',
})
export class VerMantenimientosResponsable {
  ...
  verDetalle(m: Mantenimiento): void {
    this.router.navigate(['/detalles-mantenimiento-responsable', m.id_mantenimiento]);
  }
}
