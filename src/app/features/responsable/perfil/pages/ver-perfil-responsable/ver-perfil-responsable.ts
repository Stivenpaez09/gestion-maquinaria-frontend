...
@Component({
  selector: 'app-ver-perfil-responsable',
  imports: [DatePipe, SidebarResponsable],
  templateUrl: './ver-perfil-responsable.html',
  styleUrl: './ver-perfil-responsable.scss',
})
export class VerPerfilResponsable {
  // Datos principales
