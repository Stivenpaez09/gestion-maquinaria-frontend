...
@Component({
  selector: 'app-ver-maquinarias-responsable',
  imports: [CommonModule, RouterLink, FormsModule, SidebarResponsable],
  templateUrl: './ver-maquinarias-responsable.html',
  styleUrl: './ver-maquinarias-responsable.scss',
})
export class VerMaquinariasResponsable {
  // Datos
